...
// future it will be fetched from CMS API or similar
const skillsArray = [
    {
        Icon: TypescriptIcon,
        name: "Typescript",
...
const educationArray = [
    {
        ...
        year: "2020 - 2024",
        description: "Completed a degree in Computer Science Engineering with a focus on software development and data structures.",
    },
    {
...
export default function getSkillsArrayData(){
    return skillsArray
}
